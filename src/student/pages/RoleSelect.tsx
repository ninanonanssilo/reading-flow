      ...
      <div className="mx-auto flex min-h-screen max-w-2xl flex-col items-center justify-center px-6 py-10">
        <div className="mb-10 text-center animate-slide-up">
          <div className="mb-6 flex justify-center">
            <img src="/astronaut.png" alt="우주탐험대 캐릭터" className="h-36 w-36 rounded-[2rem] object-cover shadow-lg ring-4 ring-white" />
          </div>
        ...
        <div className="grid w-full gap-5 md:grid-cols-2">
          ...
          >
            <div className="mb-6 flex justify-center">
              <img src="/student.png" alt="학생 캐릭터" className="h-28 w-28 rounded-[1.5rem] object-cover shadow-md transition-transform group-hover:-translate-y-2 group-hover:scale-105" />
            </div>
          ...
          >
            <div className="mb-6 flex justify-center">
              <img src="/teacher.png" alt="교사 캐릭터" className="h-28 w-28 rounded-[1.5rem] object-cover shadow-md transition-transform group-hover:-translate-y-2 group-hover:scale-105" />
            </div>
